// ============================================
// STUDENT PROFILE HEADER - Header with Profile & Settings
// NEW FILE: frontend/src/components/student/StudentProfileHeader.js
// ============================================
 ...
 * Displays student profile info with settings and logout
 */
        ...
        <div style={styles.leftSection}>
          ...
          <div>
            ...
            <p style={styles.subtitle}>
              {profile?.school || 'School'} • {profile?.class || 'Class'}
            </p>
          </div>
        </div>
